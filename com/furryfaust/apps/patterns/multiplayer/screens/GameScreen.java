package com.furryfaust.apps.patterns.multiplayer.screens;
...
public class GameScreen implements Screen {
    ...
    int lostX, lostWidth, lostHeight,
            ...
            nextHeight;
    Timer.Task idsQuery, gameQuery, start;
                ...
                for (int i = 0; i != gameData.size(); i++) {
                    if (touch.x > standX && touch.x < standX + standWidth
                        ...
                        if (gameData.get(i).canStart()) {
                            if (start == null || !start.isScheduled()) {
                                ...
                                start = Timer.schedule(new Timer.Task() {
                                    @Override
                                    public void run() {
    ...
    public void refreshData() {
        if ((idsQuery == null || !idsQuery.isScheduled()) && (gameQuery == null || !gameQuery.isScheduled())) {
            if (gameData == null) {
